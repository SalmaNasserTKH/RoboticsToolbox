...
import copy
import matplotlib.pyplot as plt #SALMA ADDED THIS
class Navigation:
    ...
    def plot_bg(self, distance=None, color_map='winter',
        ...
        #fig, ax = plt.subplots(nrows=1, ncols=1) line removed for not being able to have all plots on one graph
        ax=plt.gca()## SALMA ADDED THIS INSTEAD OF THE LINE ABOVE
        ...
        if distance is None:
            ...
            ax.grid(True, alpha=0.9, color=(1,1,1))
